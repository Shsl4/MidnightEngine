...
BGFXEngine::BGFXEngine() : IMidnightEngine() {
...
std::string BGFXEngine::getNiceRendererName() {
...
std::string BGFXEngine::getNiceGPUName() {
...
void BGFXEngine::stop()
{
    shouldRun = false;
}

void BGFXEngine::restart()
{
