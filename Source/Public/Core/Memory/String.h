...
public:
     ...
     */
    explicit String(Array<char> const &array);

    /*!
     * Constructs a String by moving a char Array.
     */
    explicit String(Array<char> &&array);
     ...
     */
    NODISCARD Array<String> split(char separator) const;
     ...
     *  \return This object.
     */
    String &operator=(Array<char> &&other) noexcept override;
